...
public class Formatting {
    ...
    public static void main(String[] args) {
        ...
        /*formatted = formatter.withLocale(Locale.getDefault()).format(apollo11launch);
        System.out.println(formatted);*/
        ...
        formatter = DateTimeFormatter.ofPattern("E dd.MM.yyyy HH:mm");
        formatted = formatter.format(apollo11launch);
        System.out.println("\"E dd.MM.yyyy HH:mm\" = " + formatted);
