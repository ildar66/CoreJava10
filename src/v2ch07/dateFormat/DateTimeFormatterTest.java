...
class DateTimeFormatterFrame extends JFrame
{
   ...
   private EnumCombo<FormatStyle> dateStyleCombo = getFormatStyleEnumCombo("Short", "Medium", "Long", "Full");
   private EnumCombo<FormatStyle> timeStyleCombo = getFormatStyleEnumCombo("Short", "Medium");
   private EnumCombo<FormatStyle> dateTimeStyleCombo = getFormatStyleEnumCombo("Short", "Medium", "Long", "Full");

   private EnumCombo<FormatStyle> getFormatStyleEnumCombo(String ... arr) {
      return new EnumCombo<>(FormatStyle.class, arr);
   }
