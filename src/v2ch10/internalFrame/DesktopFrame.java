...
public class DesktopFrame extends JFrame {
    ...
    public DesktopFrame() {
        ...
        openItem.addActionListener(event ->
           {
               createInternalFrame(new JLabel(getIcon(planets[counter])), planets[counter]);
     ...
     */
    private void createInternalFrame(Component c, String t) {
...
//        iframe.setFrameIcon(new ImageIcon(getClass().getResource("document.gif")));
        iframe.setFrameIcon(getIcon("document"));
