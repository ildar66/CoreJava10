...
public class PermissionTest {
    ...
    public static void main(String[] args) {
        ...
        //System.setProperty("java.security.policy", "C:\\Users\\User\\git\\CoreJava10\\src\\v2ch09\\permissions\\PermissionTest.policy");
...
class WordCheckTextArea extends JTextArea {
    ...
    public void append(String text) {
        ...
        super.append(text + "\n");// move from #insertWords(insert in policy file must work too))
    }
}