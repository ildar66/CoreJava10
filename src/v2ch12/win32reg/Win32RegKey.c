...
#include "v2ch12.win32reg.Win32RegKey.h"
#include "v2ch12.win32reg.Win32RegKeyNameEnumeration.h"
#include <string.h>
#include <stdlib.h>
#include <windows.h>

JNIEXPORT jobject JNICALL Java_v2ch12_win32reg_Win32RegKey_getValue(JNIEnv* env, jobject this_obj, jobject name)
{  
   const char* cname;
   jstring path;
   const char* cpath;
...
JNIEXPORT void JNICALL Java_v2ch12_win32reg_Win32RegKey_setValue(JNIEnv* env, jobject this_obj,
...
JNIEXPORT jboolean JNICALL Java_v2ch12_win32reg_Win32RegKeyNameEnumeration_hasMoreElements(JNIEnv* env,
   jobject this_obj)
{  jclass this_class;
   jfieldID id_index;
   jfieldID id_count;
...
JNIEXPORT jobject JNICALL Java_v2ch12_win32reg_Win32RegKeyNameEnumeration_nextElement(JNIEnv* env,
   jobject this_obj)
{  
   jclass this_class;
   jfieldID id_index;
