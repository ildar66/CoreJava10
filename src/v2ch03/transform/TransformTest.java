...
public class TransformTest
{
   public static void main(String[] args) throws Exception
   {
      ...
      // else path = Paths.get(System.getProperty("user.home"), "git", "CoreJava10", "src", "v2ch03","transform", "makehtml.xsl");
      else path = Paths.get(System.getProperty("user.home"), "git", "CoreJava10", "src", "v2ch03","transform", "makeprop.xsl");
      try (InputStream styleIn = Files.newInputStream(path))
      {
         ...
         try (InputStream docIn = Files.newInputStream(Paths.get(System.getProperty("user.home"), "git", "CoreJava10", "src", "v2ch03","transform", "employee.dat")))
         {
